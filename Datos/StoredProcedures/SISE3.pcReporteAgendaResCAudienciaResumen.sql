...
-- Description:	Obtiene los datos para el reporte de carga de trabajo de resoluciones en audiencia/Resumen
-- Ejemplo de ejecución: EXEC [SISE3].[pcReporteAgendaResCAudienciaResumen] 1509, 60250, '2000-01-01', '2024-10-31'

-- ==========================================================================================
CREATE PROCEDURE [SISE3].[pcReporteAgendaResCAudienciaResumen] 
(
	@pi_OrganismoId INT,
	@pi_IdJuez BIGINT,
...
BEGIN
	...
	GROUP BY ra.fkIdTipoResolucion
		,ra.sDescripcionResolucion
