...
namespace AgendaCJPF.Application.AgendaCJPF.Comandos.CambioJuezCJPF
{
    public class CambioJuezCJPFService
    {
        ...
        public ResultadoOperacion CambiarJuez(CambiarJuezRequest request)
        {
            ...
            // ERROR ERR-JUZ-001: Comentario incorrecto
            // El comentario dice "Cancelada" pero debe ser "Pendiente de celebración"
            // Solo se puede cambiar el juez si la audiencia está Pendiente de celebración
            // Validar que la audiencia esté en estado Cancelada
            ...
            // ERROR ERR-JUZ-002: Operador lógico erróneo en validación de disponibilidad del juez
            // Se usa || en lugar de && por lo que siempre detecta conflicto
            ...
            // ERROR ERR-JUZ-003: Operador lógico erróneo en validación de correo
            // Se usa && en lugar de || por lo que solo envía si tiene AMBOS correos
            // cuando debería enviar si tiene AL MENOS UNO
